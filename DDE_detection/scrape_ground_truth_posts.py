...
data = pd.read_csv("DDE_detection/data/ground_truth_URLs_only.csv.gz", compression="gzip")
data2 = pd.read_csv("DDE_detection/data/ground_truth_model_predictions_URLs_only.csv.gz", compression="gzip")
...
data3.to_csv("DDE_detection/data/ground_truth.csv.gz", compression="gzip", index=False)
data4.to_csv("DDE_detection/data/ground_truth_model_predictions.csv.gz", compression="gzip", index=False)